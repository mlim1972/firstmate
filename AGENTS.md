...
When the captain invokes `/darkfactory` (optionally with project names), load the `darkfactory` skill and follow it for the manual, serial, dependency-ordered intake and overnight PR run across registered projects.
